        ...
        <div style="position: absolute; z-index: 10;">
            <div style="position: absolute; z-index: 10;">
                <button type='button' style="color: #000000; position: absolute; left: 4px; top: 0;"
                        class='btn center-block text-center btn-editar-perfil' data-bs-toggle='modal' data-perfil-id=0
                        data-bs-target='#editar_Modal_0'>
        ...
        <table id="tableUsers" class="table table-responsive">
            ...
            foreach ($listperfiles as $registro) {
                ...
                <tr>
                    ...
                    <td>
                        <button style="margin-top: 10px" type='button' style="color: #000000"
                                class='btn center-block text-center btn-editar-perfil' data-bs-toggle='modal'
                                data-perfil-id=<?php echo $registro['IDPerfil'] ?> data-bs-target='#editar_Modal_<?php echo $registro['IDPerfil'] ?>'>
                    ...
                    <td>
                        <form method="post" action="" class="eliminarForm">
                            ...
                            <button style="margin-top: 10px" type="submit" class="btn"><i
