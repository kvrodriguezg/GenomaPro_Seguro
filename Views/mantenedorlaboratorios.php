        ...
        <table id="tableUsers" class="table table-responsive">
            ...
            foreach ($listCentros as $registro) {
                ...
                <tr>
                    ...
                    <td>
                        <div>
                            <button style="margin-top: 10px;" type='button' class='btn center-block btn-editar-centro'
                                    data-bs-toggle='modal'
                                    data-id=<?php echo $registro['IDCentroMedico']; ?> data-bs-target='#editar_Modal_' <?php echo $registro['IDCentroMedico'] ?>>
                    ...
                    <td class="text-center">
                        <form method="POST" action="" id="eliminarCentroForm" class="eliminarForm">
                            ...
                            <button style="margin-top: 10px;" type="submit" class="btn center-block"><i
