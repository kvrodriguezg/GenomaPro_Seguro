...
<div class="modal fade" id="editar_Modal_<?php echo $idPerfil ?>" tabindex="-1" aria-labelledby="exampleModalLabel"
     aria-hidden="true">
                    ...
                    <div class="row">
                        ...
                        <div class="col-9 mx-auto">
                            <input type="hidden" class="form-control" name="IDPerfil"
                                   value=<?php echo $idPerfil ?> readonly>
                            <label for="tipoPerfil"> Nombre Perfil</label>
                            <input required type="text" class="form-control" name="tipoPerfil"
                                   value="<?php echo $tipoPerfil ?>">
                        </div>
                    </div>
                    <br>
                    <div class="modal-footer">
                        <button type="submit" name="GUARDAR" value="GUARDAR" class="btn"
                                style="color:white; background-color:#023059">Guardar
                        </button>
