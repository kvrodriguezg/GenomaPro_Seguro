                    ...
                    <tbody style="text-align:center; background-color: #FFFFFF">
                        ...
                        ?>
                            <tr>
                                ...
                                <td>
                                    <button type='button' style="margin-top: 10px;" class='btn w-100 center-block btn-editar-usuario' data-bs-toggle='modal' data-user-id=<?php echo $usu['IDUsuario']; ?> data-bs-target='#editar_Modal_' <?php echo $usu['IDUsuario'] ?>>
