...
<header class="navbar navbar-light fixed-top" style="background-color: #9CD0FE;">
    <div class="container">
        ...
        <nav class="nav">
            <ul class="nav">
                <li class="nav-item">
                    <a class="nav-link text-blue" href="http://localhost/integrativagrupodiandra2.0/index.php"><i
                                class="fa-solid fa-house"></i>inicio</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link text-blue"
                       href="http://localhost/integrativagrupodiandra2.0/views/centro_medico.php"> <i
                                class="fa-solid fa-stethoscope"></i>Centro Medico</a>
                </li>
