    ...
    <div style="width: 80px; height: 80px; border-radius: 100%; background-color: #023E73; display: flex; justify-content: center; align-items: center; position: relative;"
        ...
        <div style="position: absolute; z-index: 10;">
            <button type='button' style="color: #000000; position: absolute; left: 4px; top: 0;"
                    class='btn center-block text-center btn-nuevo-examen' data-bs-toggle="modal" data-id=0
            ...
            <?php while ($row = mysqli_fetch_array($examenes)) { ?>
                <tr class=>
                    <form method="post" action="recepcion.php">
                        ...
                        <td>
                            <button type="button" class="btn btn-outline-danger" <?php if ($row['IDEstado'] == 3) { ?>
                        ...
                        <td style="display: flex;">
                            ...
                            <button name="actualizarEstado" type="submit"
                                    style="border:none;background-color:white; height:70px; width:71px;"><i
                                        class="fa-solid fa-file-import fa-2xl" style="color: #023059;"></i></button>
                            <button name="eliminarRegistro" type="submit" value="Eliminar"
                                    style="border:none; background-color:white;"><i class="fa-solid fa-2xl fa-trash"
                                                                                    style="color:#023059;"></i></button>
                        </td>
                    </form>
                </tr>
            <?php } ?>
